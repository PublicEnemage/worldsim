...
echo ""
echo "  Step 2  Scenarios panel → enter '$(bold 'Greece 2010-2015 M8 Demo')'"
echo "          → Create → Select as primary"
echo "          '$(dim "We are modeling the 2010-2015 IMF programme — six years.")"
echo "          $(dim "Conditionality terms are the inputs.")"
echo "          $(dim "The simulation produces the consequences.")''"
echo ""
echo "  Step 3  Next Step × 6 (watch step counter: 1/6 → … → 6/6)"
...
echo "          $(dim "Financial and human development are live. Ecological is now live")"
echo "          $(dim "as of Milestone 8 — CO2 planetary boundary proximity, boundary-")"
echo "          $(dim "normalized against 350 ppm. Governance: dashed, labeled")"
echo "          $(dim \"'Governance — in validation.' It renders honest null, not zero —\")"
echo "          $(dim "zero would imply governance failure. The fourth axis will show")"
echo "          $(dim "composite scores when GovernanceModule promotion criteria are")"
echo "          $(dim "met at M9.")''"
echo ""
...
echo "  M7: Technical foundation — legibility baseline, compliance clean. Delivered."
echo "  M8: Ecological composite score live (CO2 boundary proximity, Rockström 2009)."
echo "      Governance axis honest null — labeled 'in validation', not zero."
echo "      Greece scenario extended to 2015, six steps. Delivered."
echo "  M9: Standards Foundation — GovernanceModule promotion (five criteria, all"
echo "      currently unmet), WGI source field certification, methodology"
echo "      publication preparation."
...
echo "  • Ecological composite score is live at M8 — boundary-normalized CO2"
echo "    proximity, Rockström 2009 reference. Governance composite score null"
echo "    at M8 — five promotion criteria not yet met. Governance renders as a"
echo "    dashed axis labeled 'Governance — in validation', not as zero."
