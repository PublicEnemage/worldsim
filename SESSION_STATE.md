...
- ⬜ **G8 Steps 6/6b re-run pending** — fresh screenshots + internal review required after PR #1233 fixes; DEMO6-002 byte-identical frame status TBD after re-capture; **Steps 7/6c/8/9 gated on re-run results**
