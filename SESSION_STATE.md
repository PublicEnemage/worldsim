...
**Last updated:** 2026-07-06 (Demo 8 prep Steps 5a–7 + 6c complete — E2E spec final, IR Agent CONDITIONAL PASS→PASS, Audience Simulation 4 personas; PRs #1767/#1768/#1769 merged; north star PASS; Step 9 authorized)
...
| Active wave | Wave 6 complete — G8 confirmed 2026-07-04 (#1748 merged); CM-D confirmed 2026-07-05 (integration PR #1757 open) |
| Active sprint groups | None — CM-D exit confirmed; Demo 8 (#1544) is next |
| Active sprint journal issues | #1751 (CM-D — closes at integration PR merge) |
...
| G8 | `_classify_direction` primary_indicator fix + GRC re-verify | #1739 ✓, #1711 ✓ | **Integrated** — BPO ACCEPT; GRC AC-1 PASS (run 28719741291); integration PR #1748 merged 2026-07-04; journal #1741 closed |
| CM-D | ARG fixture Kirchner recovery inputs + AC-1 bounds recalibration | #1750 ✓ | **Confirmed** — BPO ACCEPT; north star PASS (Bolivian ministry, ARG 2001–2003 arc); CI green; integration PR #1757 open; journal #1751 closes at merge |
...
- **Demo 8 preparation (2026-07-06, Steps 1–7 + 6c complete):** Issue #1762 (Step 1); screenshot-brief.md (Step 2); stakeholder-walkthrough.md (Step 3); spec archive (Step 4). Steps 5a–5d E2E runs complete (10/10 GREEN). Step 6b internal review (DEMO-167–202). Step 7 IR Agent CONDITIONAL PASS → PASS after PR #1769 (IR-M19-001 Frame A metric fix + IR-M19-002 developer language removal). Step 6c Audience Simulation (4 personas): DEMO-203–232 (30 findings, 2 CRITICAL/14 HIGH/10 MEDIUM/4 LOW); aggregate artifact at `docs/demo/m19/reviews/2026-07-06-v0.19.0-audience-simulation.md`. **North star gate: PASS** (Aicha DEMO-232 conditions met). **Step 9 authorized.** PRs merged: #1767 (PSP arc race condition + DEMO-167/178B/189/201), #1768 (reserve_coverage_months 2.4→2.8; Frame A/B differentiation), #1769 (IR-M19-001 Frame A poverty headcount + IR-M19-002 methodology language). 3 pre-session presenter prep actions required before Step 9: (1) choreograph Act1→OptionC navigation path (<45s), (2) script Troika CI/pre-cal/verify-before-citing answers, (3) do NOT navigate to Frame E. Post-Demo 8 backlog: DEMO-217 two-scenario navigation structural gap; Pattern A uncertainty labels without step context; Pattern C HCL blank rows where cohort data exists.
