...
**Last updated: 2026-06-26 (G4 COMPLETE PR #1300; G2 Phase 3 FULLY UNBLOCKED — EL approved + #1249 gate cleared; G3 Phase 3 gated on EL sprint entry approval; G3 early QA PR #1301 merged; PR #1290 closed)**
...
| #394 | feat: multi-scenario comparison (>2 scenarios) | G2 | Wave 2 | **G2 Phase 3 IMPLEMENTATION UNBLOCKED 2026-06-25** — EL approved (PR #1298) + #1249 merged (PR #1300). Cut `feat/m17-g2-multi-scenario` from `release/m17` to begin. Sprint entry: `docs/process/sprint-plans/m17-g2-sprint-entry.md` (`el-approved: 2026-06-25`; gate cleared). |
| #1252 | arch(zone-1b): Zone 1B proportional allocation — MDA alert vs cohort sections | G3 | Wave 2 | **Phase 1 BPO ACCEPTED + Phase 2 ADR-018 ACCEPTED 2026-06-25** — PR #1291 merged; ARCH-012 → ADR-018; [ADR-VALUE]=80px (all breakpoints); G3 sprint entry gate: QA✅ (PR #1301 merged — AC-A2 test.fail() EX-002 NM-065; testid reconciled); **#1250 merge gate CLEARED** (PR #1300); **EL sprint entry approval PENDING** |
