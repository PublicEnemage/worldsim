/**
 * WorldSim Stakeholder Demo — Screen-Recorded Narrated Walkthrough (M8) — ARCHIVED
 *
 * Archived at M10. Superseded by demo-narrated-m10.spec.ts (Argentina 2001–2004 Demo 3).
 * Greece 2010–2015, six steps. EcologicalModule live (CO2 boundary proximity).
 * Governance axis: dashed null, labeled "in validation" (governance was not yet promoted).
 *
 * Screenshots located in docs/demo/m8/screenshots/.
 * UX Agent brief: docs/demo/m8/screenshot-brief.md
 *
 * DO NOT run this spec — use demo-narrated-m10.spec.ts for Demo 3.
 * ─────────────────────────────────────────────────────────────────────────────
 */
