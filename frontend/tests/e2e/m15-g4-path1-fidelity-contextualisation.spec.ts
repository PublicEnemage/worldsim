 ...
 *   AC-4:  page.route() for /entities/{entity}/data-quality -> is_synthetic: true mock
 *   AC-5:  page.route() for POST /entities/SEN/pull -> queued status mock
 *   AC-6:  page.route() for pull + /trajectory -> controlled mocks
 *   AC-11/AC-12: page.route() for /scenarios/{id}/fidelity-context -> ARG mapping
 *   AC-13: page.route() for /scenarios/{id}/fidelity-context -> null analogous_case
 *
