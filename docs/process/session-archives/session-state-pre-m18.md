# WorldSim Session State — Archive: M1–M17 (pre-M18)

> **Archive.** This file is the complete SESSION_STATE.md as it existed at M17 close
> (2026-06-26). It is permanent institutional memory — do not edit or delete.
> Current session state lives in `SESSION_STATE.md` (cockpit card, ≤200 lines).
> Authority: `docs/process/sprint-group-isolation.md §SESSION_STATE.md Cockpit Card Protocol`.

---

# Original content below — WorldSim Session State
