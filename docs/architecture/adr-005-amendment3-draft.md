...
> Produced by Architect Agent session, 2026-05-17.
> Panel review (Data Architect, QA Lead, Ecological Economist, Chief Methodologist)
> required before this draft is committed to ADR-005-human-cost-ledger.md.
> Engineering Lead disposition of panel findings required before acceptance.
> Do not reference this file as an accepted ADR — it has no architectural authority.
> See `docs/adr/ADR-005-human-cost-ledger.md` for the current accepted ADR.
>
> Five open questions for the review panel are at the end of this file.
