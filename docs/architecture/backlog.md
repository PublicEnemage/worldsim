...
| ARCH-004 | #366 | Trajectory view as primary instrument | 2026-05-21 | PANEL REVIEW — ADR-010 | 10 | M9 | Drafted 2026-05-22. Panel: FA (conditional ✓), UX Designer (conditional ✓), CM (conditional ✓), EL pending. 4 INCORPORATE items applied. EL acceptance gates M9 FA brief. |
