...
| ARCH-006 | #751 + #752 | External sector module — new module boundary (G5: BilateralTradeShock + CommodityPriceShock) | 2026-06-05 | ASSIGNED — ADR-012 | 12 | M12 | Panel: Architect Agent (author), CE (C), CM (C), Development Economist (C), EL (A). ADR drafted 2026-06-05; awaiting EL acceptance before G5 PR merges. |
