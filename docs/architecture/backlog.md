...
| ARCH-006 | TBD | External sector module — new module boundary (G5: BilateralTradeShock + CommodityPriceShock) | 2026-06-05 | PENDING_NUMBER | 12 | M12 | Required for G5. On critical path. Panel: Architect Agent (author), Chief Engineer, Chief Methodologist, Development Economist, Engineering Lead. Do not begin G5 implementation until ACCEPTED. |
| ARCH-007 | TBD | Political economy module — new module boundary (G9: conditionality, political feasibility, elite capture) | 2026-06-05 | PENDING_NUMBER | 13 | M12 | Required for G9. Parallel track to G5. Panel: Architect Agent (author), Political Economist, Chief Methodologist, Engineering Lead. Do not begin G9 implementation until ACCEPTED. |
