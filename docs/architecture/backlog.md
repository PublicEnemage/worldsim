...
| ARCH-007 | #792 | Political economy module — new module boundary (G9: conditionality, political feasibility, elite capture) | 2026-06-05 | PROPOSED — ADR-013 — panel review complete 2026-06-12; EL acceptance vote pending | 13 | M12→M13 | Required for G9 (deferred to M13). Panel: Architect Agent (author), Political Economist, Chief Methodologist, Engineering Lead. Do not begin G9 implementation until ACCEPTED. |
